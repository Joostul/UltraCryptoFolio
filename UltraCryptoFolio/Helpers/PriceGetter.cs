...
namespace UltraCryptoFolio.Helpers
{
    public class PriceGetter : IPriceGetter
    {
        ...
        public async Task<decimal> GetEuroPriceOfAsync(CryptoCurrency cryptoCurrency, DateTime? dateTime = null)
        {
            ...
            {
                var unixTimeStamp = (Int32)(_dateTime.Subtract(new DateTime(1970, 1, 1)).TotalSeconds);
